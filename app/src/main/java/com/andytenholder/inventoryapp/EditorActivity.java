...
public class EditorActivity extends AppCompatActivity implements
    ...
    /** EditText field to enter the item's picture */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPictureEditText = (EditText) findViewById(R.id.edit_item_picture);
        ...
        mPictureEditText.setOnTouchListener(mTouchListener);
    ...
    private void saveItem() {
        ...
        String pictureString = mPictureEditText.getText().toString().trim();
        ...
        values.put(Contract.InventoryEntry.COLUMN_NAME, nameString);
        values.put(Contract.InventoryEntry.COLUMN_PICTURE, pictureString);
        values.put(Contract.InventoryEntry.COLUMN_SUPPLIER, supplierString);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // If this is a item, hide the "Delete" menu item.
        if (mCurrentItemUri == null) {
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                Contract.InventoryEntry.COLUMN_SUPPLIER,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierColumnIndex = cursor.getColumnIndex(Contract.InventoryEntry.COLUMN_SUPPLIER);
            int pictureColumnIndex = cursor.getColumnIndex(Contract.InventoryEntry.COLUMN_PICTURE);
            ...
            mPictureEditText.setText(picture);
        }
    }
