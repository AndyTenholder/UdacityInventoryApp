...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOrderMore = (Button) findViewById(R.id.button_order_more);
        ...
        //Find the increase quantity button in the activity_editor
        Button quantityIncrease = (Button) findViewById(R.id.button_increase_quantity);
        //Set an OnClickListener on the increase button
        ...
        //Find the decrease quantity button in the activity_editor
        Button quantityDecrease = (Button) findViewById(R.id.button_decrease_quantity);
        //Set an OnClickListener on the decrease button
    ...
    private void orderMore() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.order_to, itemName));
        intent.putExtra(Intent.EXTRA_TEXT, getString(R.string.order_summary, itemName));
    ...
    private void saveItem() {
        ...
        if (mCurrentItemUri == null &&
                ...
                TextUtils.isEmpty(quantityString) && TextUtils.isEmpty(supplierString) && TextUtils.isEmpty(mImageUriString)) {
        ...
        values.put(Contract.InventoryEntry.COLUMN_PICTURE, mImageUriString);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                if (validation()) {
                    ...
                    Toast.makeText(EditorActivity.this, getString(R.string.save_validation), Toast.LENGTH_LONG).show();
                }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mImageUriString = cursor.getString(pictureColumnIndex);
            int price = cursor.getInt(priceColumnIndex);
            int quantity = cursor.getInt(quantityColumnIndex);
            Uri imgUri = Uri.parse(mImageUriString);
    ...
    private void increaseQuantity(){
        ...
        quantity = quantity+1;
        String mQuantityString = String.valueOf(quantity);
        mQuantityEditText.setText(mQuantityString);
    }
    ...
    private boolean validation() {
        ...
        if (supplier.length() != 0 && name.length() != 0 && mImageUriString != null && priceString.length() != 0 && quantityString.length() != 0 ) {
            return true;
        } else {
            return false;
        }
        ...
        switch (requestCode) {
            case PERMISSION_REQ:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(EditorActivity.this, "App requires storage permission, please review your permissions", Toast.LENGTH_LONG).show();
                }
        }
    }
